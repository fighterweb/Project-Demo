...
public class VideoActivity extends Activity implements OnBufferingUpdateListener,
	...
	private void playVideo() {
		...
		try {
			...
			if(bundle.getInt("VIDEO_ID") == 0){
				
				path = "rtsp://192.168.1.230:1935/vod/mp4:sample.mp4";
			}else if(bundle.getInt("VIDEO_ID") == 1){
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		// If not create the thread,can use it. START
		// playVideo();
		// If not create the thread,can use it. END
